...
public class ModItems {
    ...
    public static final Item RAW_LIMESTONE = registerItem("raw_limestone", new Item(new Item.Settings()));
    ...
    public static void registerModItems() {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.INGREDIENTS).register(entries -> { //add custom items to the Ingredients menu
            entries.add(PINK_GARNET);
            entries.add(RAW_LIMESTONE);
        });

        ItemGroupEvents.modifyEntriesEvent(ItemGroups.FOOD_AND_DRINK).register(entries -> { //add custom items to food menu
